...
namespace ServiceTest
{
    public class Tests
    {
        ...
        [Test]
        public async Task Test_GeothermalPropertiesCompletionOrder_PUT()
        {
            ...
            geothermalPropertiesCompletionOrder.Name = "My test GeothermalPropertiesCompletionOrder with modified name";
            geothermalPropertiesCompletionOrder.LastModificationDate = DateTimeOffset.UtcNow;
            try
            {
                await nSwagClient.PutGeothermalPropertiesCompletionOrderByIdAsync(geothermalPropertiesCompletionOrder.MetaInfo.ID, geothermalPropertiesCompletionOrder);
            }
            catch (ApiException ex)
            {
                TestContext.WriteLine("Impossible to PUT GeothermalPropertiesCompletionOrder of given Id\n" + ex.Message);
            }
            try
            {
                geothermalPropertiesCompletionOrder2 = await nSwagClient.GetGeothermalPropertiesCompletionOrderByIdAsync(guid);
            ...
            {
                TestContext.WriteLine("Impossible to GET the updated GeothermalPropertiesCompletionOrder of given Id\n" + ex.Message);
            }
            Assert.That(geothermalPropertiesCompletionOrder2, Is.Not.Null);
            Assert.That(geothermalPropertiesCompletionOrder2.MetaInfo, Is.Not.Null);
